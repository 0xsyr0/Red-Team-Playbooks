...
- [COM Hijacking](https://github.com/0xsyr0/Red-Team-Playbooks/blob/master/5-Installation/5.1-Persistence.md#COM-Hijacking)
...
- [InprocServer32 Persistence](https://github.com/0xsyr0/Red-Team-Playbooks/blob/master/5-Installation/5.1-Persistence.md#InprocServer32-Persistence)
...
- [Quick Persistence](https://github.com/0xsyr0/Red-Team-Playbooks/blob/master/5-Installation/5.1-Persistence.md#Quick-Persistence)
- [Registry Writes Without Registry Callbacks](https://github.com/0xsyr0/Red-Team-Playbooks/blob/master/5-Installation/5.1-Persistence.md#LRegistry-Writes-Without-Registry-Callbacks)
...
- [Task Scheduler](https://github.com/0xsyr0/Red-Team-Playbooks/blob/master/5-Installation/5.1-Persistence.md#Task-Scheduler)
...
```cmd
C:\> reg export HKCU C:\Windows\Tasks\<FILE>.reg
```
